...
class HyperionTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        try:
            print "\nHyperion connection:"
            cls.__hyp = Hyperion(_HYP_SERVER_IP_ADDRESS, _HYP_SERVER_PORT)
    ...
    def test_color_request(self):
        ...
        try:
            self.__hyp.sendColor(0x00FF0000, _HYP_PRIORITY, _HYP_DURATION)
    ...
    def test_image_request(self):
        ...
        try:
            self.__hyp.sendImage(1, 1, bytearray([0x00, 0xFF, 0x00]), _HYP_PRIORITY,
                                 _HYP_DURATION)
